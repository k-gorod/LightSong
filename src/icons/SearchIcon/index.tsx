...
export const SearchIcon: FC<ISearchIcon> = ({ inverseColor, onClick }) => {
    return (
        ...
        // </svg>
        <svg className={`${styles['searchIcon']} ${inverseColor ? styles['searchIcon-inverse'] : ""}`} onClick={onClick} viewBox="0 0 60 60" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
